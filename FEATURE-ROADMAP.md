...
| FR-012 | Linux desktop location discovery for Home/XDG user directories plus mounted-filesystem and removable-media candidates, while keeping discovery separate from explicit provider authorization. | High | Validated development foundation on authoritative implementation merge `1b6f34828d66c6f2869dda3b95429664f520de41`; exact-main Linux run `34339309370` and Android run `34339309406` passed; discovery remains read-only and requires explicit selection/provider authorization |
